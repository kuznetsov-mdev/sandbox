package com.sandbox.compose.newsapp.presentation.news_navigator.component
...
import com.sandbox.compose.newsapp.presentation.Dimens.IconSize_18
                ...
                icon = {
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        Icon(
                            ...
                            modifier = Modifier.size(IconSize_18)
                        )
                        Spacer(modifier = Modifier.height(SmallPadding_6))
                        Text(
                            text = item.text,
